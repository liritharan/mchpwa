...
if(!isset($_COOKIE["sweet4"])) {
    $sweet4 = 0;
} else {
    $sweet4 = $_COOKIE["sweet4"];
}

if(!isset($_COOKIE["sweet5"])) {
    $sweet5 = 0;
} else {
    $sweet5 = $_COOKIE["sweet5"];
}
...
if(!isset($_COOKIE["snack4"])) {
    $snack4 = 0;
} else {
    $snack4 = $_COOKIE["snack4"];
}

if(!isset($_COOKIE["snack5"])) {
    $snack5 = 0;
} else {
    $snack5 = $_COOKIE["snack5"];
}

if(!isset($_COOKIE["snack6"])) {
    $snack6 = 0;
} else {
    $snack6 = $_COOKIE["snack6"];
}

if(!isset($_COOKIE["snack7"])) {
    $snack7 = 0;
} else {
    $snack7 = $_COOKIE["snack7"];
}
...
function myFunction() {
  ...
  var snack7 = parseInt(document.getElementById("snack7").value);
    ...
    setCookie("sweet4", sweet4);
    setCookie("sweet5", sweet5);
    setCookie("snack1", snack1);
    setCookie("snack2", snack2);
    setCookie("snack3", snack3);
    setCookie("snack4", snack4);
    setCookie("snack5", snack5);
    setCookie("snack6", snack6);
    setCookie("snack7", snack7);
...
var result = coffee + tea + milk;
  ...
  document.getElementById("more").style.display = "none";
   ...
   if((((milk >= 25)&&(coffee >= 25)&&(tea >= 25))||((milk >= 25)&&(coffee == 0)&&(tea == 0))||((milk == 0)&&(coffee >= 25)&&(tea == 0))||((milk == 0)&&(coffee == 0)&&(tea >= 25))||((milk >= 25)&&(coffee == 0)&&(tea >= 25))||((milk == 0)&&(coffee >= 25)&&(tea >= 25))||((milk >= 25)&&(coffee >= 25)&&(tea == 0)))&&(res>=625)&&((bal <= 0)||(bal == 625)))
   {
...
<nav class="navbar navbar-default" style="background-color: #E31E24;">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li><a href="./smallevent.html"><i class="fa fa-arrow-left"></i></a></li>
    </ul>
  </div>
</nav>
...
<div class="wrapper center-block">
  ...
  <tbody>
    <tr>
      ...
      <td>Coffee</td>
      <td>&#8377; 25</td>
      <td id="myinpc"><input type="number" class="form-control" min="25" id="coffee" onchange="myFunction()" value="<?php echo $coffee; ?>" name="coffee"></td>
    </tr>
    <tr>
      <th scope="row"><img src="./tea.jpg" height="40px" width="40px"></th>
      <td>Tea</td>
      <td>&#8377; 25</td>
      <td id="myinpt"><input type="number" class="form-control" min="25" id="tea" onchange="myFunction()" value="<?php echo $tea; ?>" name="tea"></td>
    </tr>
    <tr>
      <th scope="row"><img src="./milk.png" height="40px" width="40px"></th>
      <td>Milk</td>
      <td>&#8377; 25</td>
      <td id="myinpm"><input type="number" class="form-control" min="25" id="milk" onchange="myFunction()" value="<?php echo $milk; ?>" name="milk"></td>
    </tr>
  </tbody>
</table>
</div>
